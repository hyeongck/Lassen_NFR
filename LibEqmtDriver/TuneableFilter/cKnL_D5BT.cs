...
{
    public class cKnL_D5BT : iTuneFilterDriver
    {
        ...
        void iTuneFilterDriver.Initialize()
        {
            try
            {
        ...
        double iTuneFilterDriver.ReadFreqMHz()
        {
            string result;
            double freqMHz;
        ...
        void iTuneFilterDriver.SetFreqMHz(double freqMHz)
        {
            double freqKHz = freqMHz * 1e3;
            myVisaEq.WriteString("F" + freqKHz, true);
        }
        void iTuneFilterDriver.Reset()
        {
        }
        #endregion
